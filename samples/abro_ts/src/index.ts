...
export async function cli(): Promise<void> {
  ...
  const receiveVariables = (line: string): void => {
    try {
      ...
      if (typeof json.A === 'boolean') context.setA(json.A);
      if (typeof json.B === 'boolean') context.setB(json.B);
      if (typeof json.R === 'boolean') context.setR(json.R);
      if (typeof json.O === 'boolean') context.setO(json.O);
